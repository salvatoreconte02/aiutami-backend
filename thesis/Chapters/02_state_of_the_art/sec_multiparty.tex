...
% ----------------------------------------------------------
\subsection{Why Multi-Party Is Different}
\label{subsec:multiparty-why}
...
% ----------------------------------------------------------
\subsection{Taxonomies of Multi-Party Conversational AI}
\label{subsec:multiparty-taxonomies}
...
Section~\ref{sec:gaps}, all three properties take on fundamentally different
...
% ----------------------------------------------------------
\subsection{Existing Multi-Party Systems}
\label{subsec:multiparty-systems}
...
Section~\ref{subsec:multiparty-taxonomies}.
...
% ----------------------------------------------------------
\subsection{Technical Challenges of Multi-Party Speech}
\label{subsec:multiparty-technical}
...
% ----------------------------------------------------------
\subsection{Gap~1: Multi-Party Speech-Based AI---the Nearly Empty Quadrant}
\label{subsec:gap1}
...
% ----------------------------------------------------------
\subsection{Gap~2: End-to-End and Half-Cascade Architectures for Multi-Party}
\label{subsec:gap2}
...
% ----------------------------------------------------------
\subsection{Gap~3: Design Taxonomy for Multi-Party Speech}
\label{subsec:gap3}
...
% ----------------------------------------------------------
\subsection{Gap~4: Audio-Only Addressee Detection in Groups with $N > 2$}
\label{subsec:gap4}
...
% ----------------------------------------------------------
\subsection{Gap~5: Dynamic Agent Control in Speech Contexts}
\label{subsec:gap5}
...
% ----------------------------------------------------------
\subsection{Gap~6: Incomplete Utterance Handling in Multi-Party Speech}
\label{subsec:gap6}
...
% ----------------------------------------------------------
\subsection{Gap~7: Benchmarks for Multi-Party Speech-Based CA}
\label{subsec:gap7}
...
% ----------------------------------------------------------
\subsection{Gap~8: Amplified Proactivity Risk in Speech}
\label{subsec:gap8}
...
% ----------------------------------------------------------
\subsection{The Research Landscape as a 2$\times$2 Matrix}
\label{subsec:matrix}
...
% ----------------------------------------------------------
\subsection{How AIutami Addresses Known Challenges}
\label{subsec:aiutami-solutions}
...
\label{subsec:aiutami-limitations}
...
Gaps~4--8 identified in Section~\ref{sec:gaps} and represent the most
