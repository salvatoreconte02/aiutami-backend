...
# Sottoinsieme enforced a runtime (rules 2, 4, 5).
...
The participants are tackling the NASA Moon Survival Challenge. They are a crew of astronauts whose lunar module has crash-landed about 300 km from the base on the lit side of the Moon. They must rank 15 items in order of importance for survival and reaching the base. The goal is to reach group consensus on a single shared ranking.
...
The participants have tackled the NASA Moon Survival Challenge. At the end of the session the host must confirm the final ranking of the 15 items in the interface. The ranking should reflect the consensus reached by the group during the discussion."""
