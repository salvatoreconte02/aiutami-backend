...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{scenarios/scenario1_signin.jpg}
    \caption{Sign up interface for new user registration.}
    \label{fig:scenario1}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{scenarios/scenario2_login.jpg}
    \caption{Login interface for existing users.}
    \label{fig:scenario2}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{scenarios/scenario3_createnewsession_.jpg}
    \caption{Session creation interface with context selection and title input.}
    \label{fig:scenario3}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{scenarios/scenario4_joinsession.jpg}
    \caption{Join session interface where users paste the invitation link.}
    \label{fig:scenario4}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{scenarios/scenario5_startsession.jpg}
    \caption{Lobby interface showing participants and the start session button for the host.}
    \label{fig:scenario5}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{scenarios/scenario7_reservation.jpg}
    \caption{Discussion interface showing a turn reservation request.}
    \label{fig:scenario7}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{scenarios/scenario8_inactiveuser.jpg}
    \caption{Private notification displayed to an inactive user, prompting participation.}
    \label{fig:scenario8}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{scenarios/scenario9_readytoconclude.jpg}
    \caption{Discussion interface with the ``Ready to conclude'' button.}
    \label{fig:scenario9}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{scenarios/scenario10_voting.jpg}
    \caption{Voting interface showing the list of suspects for selection.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{scenarios/scenario12_report.jpg}
    \caption{Session report showing voting results and discussion summary.}
    \label{fig:scenario12}
\end{figure}
