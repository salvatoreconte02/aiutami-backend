...
\textbf{MVP Focus:} For the purpose of this project, the implementation targets the Murder Mystery experimental paradigm~\cite{Stasser1985PoolingUnshared, Stasser1992HiddenProfiles}, where participants must collaborate vocally to solve a case. This context was chosen because it naturally exhibits the challenges the system aims to address: multiple voices competing to speak, risk of dominant participants, and the need for structured turn-taking to reach a shared conclusion.
