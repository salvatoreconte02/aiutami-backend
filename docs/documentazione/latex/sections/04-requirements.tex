...
\textbf{Secondary users} are those who oversee or facilitate discussions without being the main speakers. This category includes teachers and trainers who monitor student participation, team leaders and managers who guide collaborative sessions, and facilitators who use the system as a support tool for group dynamics.
...
\textbf{MVP Focus:} For the purpose of this project, the implementation targets a specific entertainment scenario---the Murder Mystery game---where participants must collaborate vocally to solve a case. This context was chosen because it naturally exhibits the challenges the system aims to address: multiple voices competing to speak, risk of dominant participants, and the need for structured turn-taking to reach a shared conclusion.
...
\textbf{MVP Scope:} The current implementation focuses on the Murder Mystery entertainment scenario with 3 participants collaborating to solve a case through structured vocal interaction.
...
\textbf{LLM behavioral limitations} --- The language model powering the AI moderator has limited customization. Content moderation policies and inherent model behaviors may occasionally produce responses that are not perfectly suited to the moderation context, requiring careful prompt engineering.
...
% TODO: Insert UNG diagram image
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.8\textwidth]{ung-diagram.png}
